...
class DeliveryPickupNotifier implements EventSubscriberInterface {
    ...
    public function onDeliveryPickup(ActivityEvent $event)
    {
        ...
        try {
            ...
            $emailNotification->setType(NotificationType::DELIVERY_PICKED_UP);
            $emailNotification->setSubject('Livraison ramassée');
            $emailNotification->setTitle('Livraison ramassée');
            ...
            $emailNotification->setBody("Votre livraison a été ramassée par le livreur. Veuillez consulter les détails ci-dessous.");
            ...
            $recipientWhatsappNotification->setType(NotificationType::DELIVERY_PICKED_UP);
            $recipientWhatsappNotification->setSubject('Livraison ramassée');
            $recipientWhatsappNotification->setTitle('Livraison ramassée');
            $recipientWhatsappNotification->setBody('Bonjour, votre livraison a été ramassée par le livreur et est en route.');
            ...
            if ($delivery->getRecipient() && $delivery->getRecipient()->getEmail()) {
                ...
                $recipientEmailNotification->setType(NotificationType::DELIVERY_PICKED_UP);
                $recipientEmailNotification->setSubject('Livraison ramassée et en route');
                $recipientEmailNotification->setTitle('Livraison ramassée');
                $recipientEmailNotification->setBody("Bonjour, votre livraison a été ramassée par le livreur et est en route. Veuillez consulter les détails ci-dessous.");
            ...
            $adminEmailNotification->setType(NotificationType::DELIVERY_PICKED_UP);
            $adminEmailNotification->setSubject('[ADMIN] Livraison ramassée');
            $adminEmailNotification->setTitle('Livraison ramassée');
            $adminEmailNotification->setBody("Une livraison a été ramassée par le livreur. Veuillez consulter les détails ci-dessous.");
            ...
            $adminWhatsappNotification->setType(NotificationType::DELIVERY_PICKED_UP);
            $adminWhatsappNotification->setSubject('[ADMIN] Livraison ramassée');
            $adminWhatsappNotification->setTitle('Livraison ramassée');
            $adminWhatsappNotification->setBody('Une livraison a été ramassée par le livreur.');
            ...
            if ($delivery->getDeliveryPerson() && $delivery->getDeliveryPerson()->getEmail()) {
                ...
                $deliveryPersonEmailNotification->setType(NotificationType::DELIVERY_PICKED_UP);
                $deliveryPersonEmailNotification->setSubject('Confirmation de ramassage');
                $deliveryPersonEmailNotification->setTitle('Livraison ramassée');
                $deliveryPersonEmailNotification->setBody("Bonjour, vous avez ramassé une livraison. Veuillez consulter les détails ci-dessous.");
            ...
            if ($delivery->getDeliveryPerson() && $delivery->getDeliveryPerson()->getPhone()) {
                ...
                $deliveryPersonWhatsappNotification->setType(NotificationType::DELIVERY_PICKED_UP);
                $deliveryPersonWhatsappNotification->setSubject('Confirmation de ramassage');
                $deliveryPersonWhatsappNotification->setTitle('Livraison ramassée');
                $deliveryPersonWhatsappNotification->setBody('Bonjour, vous avez ramassé une livraison.');
